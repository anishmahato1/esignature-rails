...
ActiveRecord::Schema[7.1].define(version: 2025_05_04_190807) do
  ...
  create_table "document_signatures", force: :cascade do |t|
    ...
    t.index ["signature_id"], name: "index_document_signatures_on_signature_id"
  end
  ...
  add_foreign_key "document_signatures", "signatures"
